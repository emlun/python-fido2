...
def test_pfb_ex_5_3_1():
    ...
    assert log == [
        ...
        (crv.point([12], [16]), fq4.el([4, 9, 21, 20]), fq4.el([33, 36, 19, 6]), fq4.el([21, 2, 32, 41]), fq4.el([21, 2, 32, 41])),
        (crv.point([27], [14]), fq4.el([9, 38, 18, 40]), fq4.el([18, 20, 8, 39]), fq4.el([17, 28, 5, 4]), fq4.el([33, 30, 27, 22])),
        (crv.point([18], [31]), fq4.el([14, 8, 15, 29]), fq4.el([30, 41, 32, 18]), fq4.el([28, 33, 13, 6]), fq4.el([37, 21, 2, 36])),
        (crv.point([45], [24]), fq4.el([19, 14, 3, 10]), fq4.el([20, 25, 26, 21]), fq4.el([20, 1, 45, 46]), fq4.el([25, 40, 21, 10])),
        (crv.zero(), fq4.el([27, 0, 7]), fq4.el([31, 0, 31]), fq4.el([43, 0, 6]), fq4.el([22, 10, 6, 17])),
    ]
